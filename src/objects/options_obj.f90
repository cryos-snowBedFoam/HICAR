...
!       store options
    ...
    subroutine var_namelist(filename,options)
        ...
        character(len=MAXVARLENGTH) :: svf_var, hlm_var, slope_var, slope_angle_var, aspect_angle_var, ridge_dist_var, valley_dist_var, ridge_drop_var, factor_p_var  !!MJ added
        ...
        namelist /var_list/ pvar,pbvar,tvar,qvvar,qcvar,qivar,qrvar,qgvar,qsvar,qncvar,qnivar,qnrvar,qngvar,qnsvar,&
                            ...
                            lat_ext, lon_ext, swe_ext, hsnow_ext, rho_snow_ext, tss_ext, tsoil2D_ext, tsoil3D_ext, z_ext, time_ext, &
                            svf_var, hlm_var, slope_var, slope_angle_var, aspect_angle_var, ridge_dist_var, valley_dist_var, ridge_drop_var, factor_p_var !! MJ added
